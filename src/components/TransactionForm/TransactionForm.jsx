...
const TransactionForm = ({ handelOpenCategoriesList, resetForm, handlerChange, form, category }) => {
        ...
        <>
            ...
            >
                ...
                <label className={s.label}>Валюта
                    <input className={s.inputCurrency} 
                        type="button" name="currency" 
                        onChange={handlerChange} 
                        value={currency} 
                    />
                </label>
                <label className={s.label}>
                    <input className={s.inputcomment} 
                        type="text" 
                        name="comment" 
                        onChange={handlerChange} 
                        value={comment} 
